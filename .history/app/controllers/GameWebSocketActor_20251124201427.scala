...
/**
  ...
  * Das Companion-Object hält eine Liste aller Connections
  * und kann Broadcasts an alle Spieler senden.
  */
object GameWebSocketActor {
  ...
  /** Kann vom Backend benutzt werden, um Infos zu pushen. */
