...
import play.silhouette.impl.providers.oauth2.{GitHubProvider, PlayWSHTTPClient}
...
class SilhouetteModule extends AbstractModule {
  ...
  def provideAuthenticatorService()(implicit ec: ExecutionContext): AuthenticatorService[CookieAuthenticator] = {
    // ✅ Default-Konfiguration verwenden (keine CookieAuthenticatorSettings Klasse nötig)
    new CookieAuthenticatorService(
      None, // repository (stateless)
