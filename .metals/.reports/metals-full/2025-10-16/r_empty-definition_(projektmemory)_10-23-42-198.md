error id: file:///C:/Users/leo11/OneDrive/Desktop/HTWG/AIN/Semester5/Web-apps/ProjektMemory/src/main/scala/aview/gui/StartGui.scala:
file:///C:/Users/leo11/OneDrive/Desktop/HTWG/AIN/Semester5/Web-apps/ProjektMemory/src/main/scala/aview/gui/StartGui.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/swing/playerCount.
	 -scala/swing/playerCount#
	 -scala/swing/playerCount().
	 -scala/swing/event/playerCount.
	 -scala/swing/event/playerCount#
	 -scala/swing/event/playerCount().
	 -playerCount.
	 -playerCount#
	 -playerCount().
	 -scala/Predef.playerCount.
	 -scala/Predef.playerCount#
	 -scala/Predef.playerCount().
offset: 4795
uri: file:///C:/Users/leo11/OneDrive/Desktop/HTWG/AIN/Semester5/Web-apps/ProjektMemory/src/main/scala/aview/gui/StartGui.scala
text:
```scala
package main
  ...
  SwingUtilities.invokeLater(new Runnable {
    def run(): Unit = {
      if (controller.getPlayerCount.isEmpty || controller.getPlayerName.isEmpty || controller.getCardCount.isEmpty) {
        ...
        val msg = "The game state has been reset (gui)."
        println(msg)
        WebLog.log(msg)          // <— NEU
      } else {
        val msg = "The game state has been updated (gui)."
        println(msg)
        WebLog.log(msg)          // <— NEU
        ...
        case ButtonClicked(_) =>
          SwingUtilities.invokeLater(new Runnable {
            def run(): Unit = {
              ...
              WebLog.log(s"GUI: set player count = $playerCount") // <— NEU
            }
          })
      }
    }
          ...
          SwingUtilities.invokeLater(new Runnable {
            def run(): Unit = {
              ...
              if (controller.gameLogic != null && staticMatrix.isEmpty) {
                ...
                WebLog.log(s"GUI: set player count = $p@@layerCount") // <— NEU
              }
            }
          })
      }
